...
def get_timings(net, h1, h2):
    ...
    for i in range(3):
        ...
        print(f"Executing command: {fetch}")  # Debug print
        process = h2.popen(fetch)
        ...
        if output:
            try:
                ...
                print(f"Added timing: {time_value}")  # Debug print
            except ValueError as e:
                print(f"Error converting output to float: {e}")  # Debug print
    
    if not timings:
        print("Warning: No timings collected!")  # Debug print
